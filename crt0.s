...
# Standard 32X Startup Code for Mega Drive side at 0x3F0
...
0:
        ...
        # Wait for 68000 to finish initializing
        mov.l   _pri_sts,r0
        mov.l   _pri_ok,r1
1:
        mov.l   @r0,r2
        ...
        mov     #0,r1
        mov.l   r1,@(4,r0)              /* Clear Secondary SH2 status */
...
pwi_clr_ovf:
        .word   0xa53e                  /* A5 = Select WTCSR, 3E = Clear OVF, IT mode, Timer enabled, CLKSEL = Fs/4096 */
...
sec_start:
        ...
        # Wait for Primary SH2 and 68000 to finish initializing
        mov.l   _sec_sts,r0
        mov.l   _sec_ok,r1
1:
        mov.l   @r0,r2
        ...
        .align   2
_sec_int_clr:
        .long   0x2000401E              /* One word passed last INT CLR register */
_sec_stk:
        .long   sec_stack               /* Cold Start SP */
_sec_sts:
        .long   0x20004024
